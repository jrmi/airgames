...
const characterConfig = [
  ...
  },
  {
    ...
    abilityCards: {
      ...
      'level-X': ['nimble-knife', 'unending-chant'],
      'level-2': ['change-tempo', 'soothing-lullaby'],
      'level-3': ['crippling-chorus', 'echoing-aria'],
      'level-4': ['disorienting-dirge', 'inspiring-anthem'],
      'level-5': ['melody-and-harmony', 'mobilizing-measure'],
      'level-6': ['provoke-terror', 'pull-the-strings'],
      'level-7': ['booming-proclamation', 'nightmare-serenade'],
      'level-8': ['commanding-presence', 'tranquil-trill'],
      'level-9': ['captivating-performance', 'shadow-puppets'],
    },
    nbAttackModifiers: 16,
  },
  {
    ...
    abilityCards: {
      ...
      'level-X': ['fresh-kill', 'sap-life', 'the-hunt-begins'],
      'level-2': ['expose', 'relentless-offensive'],
      'level-3': ['darkened-skies', 'press-the-attack'],
      'level-4': ['flight-of-flame', 'singular-focus'],
      'level-5': ['inescapable-fate', 'wild-command'],
      'level-6': ['natures-hunger', 'camouflage'],
      'level-7': ['crashing-wave', 'impending-end'],
      'level-8': ['feral-instincts', 'rising-momentum'],
      'level-9': ['lead-to-slaughter', 'predator-and-prey'],
    },
    nbAttackModifiers: 17,
  },
];
